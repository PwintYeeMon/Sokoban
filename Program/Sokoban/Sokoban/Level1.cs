...
namespace Sokoban
{
    public partial class frmLevel1 : Form
    {
        ...
        private void pbup_Click_1(object sender, EventArgs e)
        {
        ...
        private void level1down(object sender, KeyEventArgs e)
        {
        ...
        private void frmLevel1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            List<PictureBox> walls = new List<PictureBox> { wall1, wall2, wall3, wall4, wall5, wall6, wall7, wall8, wall9,
                ...
                wall36, wall37, wall38, wall39, wall40, wall41, wall42, wall43, wall44 };

            List<PictureBox> boxes = new List<PictureBox> { pbbox1, pbbox2, pbbox3, pbextrabox };

            List<PictureBox> targets = new List<PictureBox> { pbtarget1, pbtarget2, pbtarget3 };
